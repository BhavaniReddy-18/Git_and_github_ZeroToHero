...
4) Which lines of code were added, removed, or updated.
5) Restore previous versions if something goes wrong.
6) Work together with multiple developers without overwriting each other's work.
...
2) Commits, branching, and history are available offline.
3) Once the repository becomes available again, changes can be pushed to the remote repository.
